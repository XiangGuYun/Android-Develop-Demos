...
class Path2View @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) :
    ...
    private fun showCoordinate(canvas: Canvas?) {
        ...
        canvas?.drawText("(0, 0) 图2-rMoveTo", 0f, rect.height().toFloat(), paint1)
    }
