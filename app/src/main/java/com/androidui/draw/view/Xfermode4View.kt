...
class Xfermode4View @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) :
    ...
    override fun onDraw(canvas: Canvas?) {
        ...
        path.moveTo(0f, -bmp.width/2f)
        path.lineTo(bmp.width/6f, -bmp.width/6f)
        path.lineTo(bmp.width/2f, 0f)
        path.lineTo(bmp.width/6f, bmp.width/6f)
        path.lineTo(0f, bmp.width/2f)
        path.lineTo(-bmp.width/6f, bmp.width/6f)
        path.lineTo(-bmp.width/2f, 0f)
        path.lineTo(-bmp.width/6f, -bmp.width/6f)
        path.close()
