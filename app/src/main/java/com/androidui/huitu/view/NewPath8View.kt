...
class NewPath8View @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) :
    ...
    override fun onDraw(canvas: Canvas?) {
        ...
        path.addOval(-width/2f,-height/2f,width/2f,height/2f, Path.Direction.CW)
